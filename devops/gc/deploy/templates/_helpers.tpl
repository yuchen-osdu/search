...
{{- define "search.minReplicasSpot" -}}
{{- $tier := include "search.getTier" . -}}
...
{{- define "search.replicasStandard" -}}
{{- $tier := include "search.getTier" . -}}
